...
class DetailWebController: UIViewController, UIWebViewDelegate, WKNavigationDelegate {
    ...
    func webViewDidFinishLoad(_ webView: UIWebView) {
        print("Webview webViewDidFinishLoad")
    }
}
